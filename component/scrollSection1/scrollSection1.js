      ...
      <div className="w-full">
        <div className="w-full xl:min-h-screen">
          ...
          <div className="w-full xl:w-1046 flex mx-auto flex-col">
            {/* Part 1 */}
            <div id="p1" className="flex items-center justify-center flex-col xl:flex-row mx-auto xl:mx-0 w-343 md:w-545 xl:w-408 xl:h-screen">
              <div className="flex items-center flex-col">
                ...
                <p className="text-gray-700 text-base text-center xl:text-left mx-4 xl:mx-auto font-normal xl:text-lg mt-4 xl:mt-5 font-plus-jakarta-sans">Rapidly ideate on the canvas and get buy in from stakeholders with ready-made blueprints of any UI pattern you can think off</p>
              </div>

              <div className="block md:hidden mt-7">
                <Image src="/images/groupImgsSm.png" alt="" width={341} height={333} />
              </div>

              <div className="hidden md:block xl:hidden mt-12">
                <Image src="/images/groupImgsSm.png" alt="" width={545} height={520} />
              </div>
            </div>

            {/* @Part 2 */}
            <div id="p2" className="flex items-center justify-center flex-col xl:flex-row mx-auto xl:mx-0 mt-20 w-343 md:w-545 xl:w-408 xl:h-screen">
              <div>
                ...
                <p className="text-gray-700 w-full  lg:w-full md:mx-auto lg:mx-0 text-base text-center xl:text-left mx-4 font-normal xl:text-lg mt-4 lg:mt-5 font-plus-jakarta-sans">Rapidly ideate on the canvas and get buy in from stakeholders with ready-made blueprints of any UI pattern you can think off</p>
              </div>
              ...
              <div className="w-342 md:w-586 xl:hidden h-262 md:h-449 mt-10 md:mt-16 relative px-4">
                ...
                <div className="absolute top-0 left-0 h-full">
                  <div className="h-20 w-20 md:h-36 md:w-40">
                    <img className="w-full h-full" src="/images/navigation2.png" alt="" />
                  </div>
                </div>
                ...
                <div className="absolute top-0 right-0">
                  <div className="h-20 w-20 md:h-36 md:w-40">
                    <img className="w-full h-full" src="/images/navigation4.png" alt="" />
                  </div>
                </div>
                ...
                <div className="absolute top-24 right-10 md:top-40 md:right-20">
                  <div className="w-14 h-14 md:w-20 md:h-20">
                    <img className="transform -rotate-90" src="/svgs/toptoleft1.svg" alt="" />
                  </div>
                </div>
                {/* Arrow 3 */}
          ...
          <div className="w-full h-screen top-0 right-0 sticky">
            <div className="w-full h-full flex items-center">
              <div className="relative top-0 left-0">
                <div className={" xl:ml- relative top-0 left-0 borde transition duration-700 ease-in-out " + (item === "p1" ? "xl:block opacity-100" : "opacity-0")}>
                  <Image src="/images/groupImgs.png" alt="" width={514} height={501} />
                </div>

                <div className={"lg:ml- absolute top-0 left-0 borde border-gray-900 w-full h-full transition duration-700 ease-in-out " + (item === "p2" ? "xl:block opacity-100" : "opacity-0")}>
                  <div className="w-32 md:w-586 h-96 md:h-449 mt-10 relative px-4 border border-pink-700">
                    ...
                    <div className="absolute bottom-0 right-0">
                      <div className="h-24 w-28 md:h-36 md:w-40">
                        <img className="" src="/images/navigation5.png" alt="" />
                      </div>
                    </div>
                    {/* Arrow 1 */}
